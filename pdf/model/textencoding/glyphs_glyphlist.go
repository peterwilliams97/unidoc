...
func GlyphToRune(glyph string) (rune, bool) {
	// First check for glyph aliases.
	if alias, ok := glyphAliases[glyph]; ok {
		glyph = alias
	}
	if groups := reDot.FindStringSubmatch(glyph); groups != nil {
		glyph = groups[1]
	}

	// Next lookup the glyph in all the tables.
	...
	// if groups := reEncodingHex.FindStringSubmatch(glyph); groups != nil {
	// 	n, err := strconv.ParseInt(groups[1], 16, 32)
	// 	if err == nil {
	// 		return rune(n), true
	// 	}
...
var (
	reDot         = regexp.MustCompile(`^(\w+)\.\w+$`)           // a.smcp
	reEncoding    = regexp.MustCompile(`^[A-Za-z](\d{1,5})$`)    // C211
	reEncodingHex = regexp.MustCompile(`^G([\dA-F]{2})$`)        // G1D
	reUniEncoding = regexp.MustCompile(`^u(?:ni)?([\dA-F]{4})$`) //uniFB03
)
...
var tex2GlyphlistGlyphToRuneMap = map[string]rune{ // 2424 entries
	"exclam":                   '!',  //  '!'
	"octothorpe":               '#',  //  '#'
	"mathdollar":               '$',  //  '$'
	"percent":                  '%',  //  '%'
	...
	"threeunderdot":            '⃨',  //  '⃨'
	"widebridgeabove":          '⃩',  //  '⃩'
	"underrightharpoondown":    '⃬',  //  '⃬'
	"underleftharpoondown":     '⃭',  //  '⃭'
	"underleftarrow":           '⃮',  //  '⃮'
	"underrightarrow":          '⃯',  //  '⃯'
	"asteraccent":              '⃰',  //  '⃰'
	"BbbC":                     'ℂ',  //  'ℂ'
	...
	"mbfitsansNu":            '𝞜', //  '𝞜'
	"mbfitsansXi":            '𝞝', //  '𝞝'
	"mbfitsansOmicron":       '𝞞', //  '𝞞'
	"mbfitsansPi":            '𝞟', //  '𝞟'
	"mbfitsansRho":           '𝞠', //  '𝞠'
	"mbfitsansvarTheta":      '𝞡', //  '𝞡'
	"mbfitsansSigma":         '𝞢', //  '𝞢'
	"mbfitsansTau":           '𝞣', //  '𝞣'
	"mbfitsansUpsilon":       '𝞤', //  '𝞤'
	"mbfitsansPhi":           '𝞥', //  '𝞥'
	"mbfitsansChi":           '𝞦', //  '𝞦'
	"mbfitsansPsi":           '𝞧', //  '𝞧'
	"mbfitsansOmega":         '𝞨', //  '𝞨'
	...
	"mbfitsansnu":            '𝞶', //  '𝞶'
	"mbfitsansxi":            '𝞷', //  '𝞷'
	"mbfitsansomicron":       '𝞸', //  '𝞸'
	"mbfitsanspi":            '𝞹', //  '𝞹'
	"mbfitsansrho":           '𝞺', //  '𝞺'
	"mbfitsansvarsigma":      '𝞻', //  '𝞻'
	"mbfitsanssigma":         '𝞼', //  '𝞼'
	"mbfitsanstau":           '𝞽', //  '𝞽'
	"mbfitsansupsilon":       '𝞾', //  '𝞾'
	"mbfitsansphi":           '𝞿', //  '𝞿'
	"mbfitsanschi":           '𝟀', //  '𝟀'
	"mbfitsanspsi":           '𝟁', //  '𝟁'
	"mbfitsansomega":         '𝟂', //  '𝟂'
	"mbfitsanspartial":       '𝟃', //  '𝟃'
	"mbfitsansvarepsilon":    '𝟄', //  '𝟄'
	"mbfitsansvartheta":      '𝟅', //  '𝟅'
	"mbfitsansvarkappa":      '𝟆', //  '𝟆'
	"mbfitsansvarphi":        '𝟇', //  '𝟇'
	"mbfitsansvarrho":        '𝟈', //  '𝟈'
	"mbfitsansvarpi":         '𝟉', //  '𝟉'
	"mbfDigamma":             '𝟊', //  '𝟊'
